    ...
    <section id="team" className="py-16 sm:py-20 lg:py-24 bg-gradient-to-b from-white via-gray-50/50 to-white">
      <div className="container mx-auto px-4 sm:px-6">
        <SectionHeader
          ...
          description="Profesioniști dedicați pentru sănătatea ta dentară"
        />
    ...
    <div className="group relative aspect-[3/4] rounded-2xl overflow-hidden bg-gray-200">
      ...
      >
        <div>
          ...
          <p className="text-white/90 font-medium text-sm mb-3">{member.role}</p>
          <p className="text-white/80 text-sm leading-relaxed">
            {member.experience} ani experiență în {member.specializations[0].toLowerCase()}.
          </p>
        </div>
