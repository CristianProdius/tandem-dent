  ...
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center bg-background px-4 py-12 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-md text-center">
        ...
        <h1 className="mt-4 font-bold text-3xl tracking-tight sm:text-4xl">Acces neautorizat</h1>
        <p className="mt-4 text-muted-foreground">
          Nu aveți permisiunea de a vizualiza conținutul solicitat. Vă rugăm să contactați administratorul dacă
          credeți că este o eroare.
        </p>
        <div className="mt-6">
          <Link
            href="dashboard"
